						...
						<div class="beta-products-list">
							...
							<div class="col-sm-4">
								<div class="single-item">
									...
									@endif
									<div class="single-item-header">
										<a href="{{route('chitietsanpham',$spk)}}"><img src="source/image/product/{{$sp_k->image}}" alt="" height="250px"></a>
									</div>
									<div class="single-item-body">
									...
									<div class="single-item-caption">
										...
										<a class="beta-btn primary" href="{{route('chitietsanpham',$spk)}}">Details <i class="fa fa-chevron-right"></i></a>
										<div class="clearfix"></div>
									</div>
								</div>
							</div>
