				...
				<div class="col-sm-3 aside">
					<div class="widget">
						...
						<div class="widget-body">
							...
							@foreach($sp_banchay as $sp_bc)
								<div class="media beta-sales-item">
									<a class="pull-left" href="{{route('chitietsanpham',$sp_bc->id)}}"><img src="source/assets/dest/images/products/sales/{{$sp_bc->image}}" alt=""></a>
									<div class="media-body" style="font-size:18px;">
										{{$sp_bc->name}}
										<span class="beta-sales-price">{{$sp_bc->unit_price}}</span>
									</div>
								</div>
							@endforeach	
							</div>
					...
					<div class="widget">
						...
						<div class="widget-body">
							<div class="beta-sales beta-lists">
								...
								@foreach( $sp_new as $sp_n )
								<div class="media beta-sales-item">
									<a class="pull-left" href="product.html"><img src="source/assets/dest/images/products/sales/{{$sp_n->image}}" alt=""></a>
									<div class="media-body"style="font-size:18px;">
										{{ $sp_n->name }}
										<span class="beta-sales-price">{{ $sp_n->unit_price }}</span>
									</div>
								</div>
								@endforeach
							</div>
