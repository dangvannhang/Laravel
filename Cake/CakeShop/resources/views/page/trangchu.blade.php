								...
								<ul>
                                    ...
                                    style="width: 100%; height: 100%; overflow: hidden; z-index: 18; visibility: hidden; opacity: 0;">
                                        ...
                                        data-bgfit="undefined" data-bgfitend="undefined" data-owidth="undefined" data-oheight="undefined">
                                                        ...
                                                        data-src="source/image/slide/{{$sl->image}}" style="background-color: rgba(0, 0, 0, 0); 
					...
					<div class="col-sm-12">
						<div class="beta-products-list">
							...
							<div class="row">
                                ...
                                <a href="#"><img src="source/image/product/{{$new->image}}" alt="" height="250px"></a>
                                </div>
						...
						<div class="beta-products-list">
							...
							<div class="beta-products-details">
								<p class="pull-left">{{count($top_product)}} style</p>
								<div class="clearfix"></div>
							</div>
							<div class="row">
								...
								<div class="col-sm-3">
                                	...
                                	@endif
										...
										<div class="single-item-header">
											<a href="product.html"><img src="source/image/product/{{$top->image}}" alt="" height="250px"></a>
										</div>
										<div class="single-item-body">
